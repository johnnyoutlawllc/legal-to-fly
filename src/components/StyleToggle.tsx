...
export default function StyleToggle() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex items-center gap-1 rounded-full border border-[var(--border)] bg-[var(--surface)]/95 p-1 shadow-lg shadow-black/40 backdrop-blur">
